...
import com.genpact.service.QbProjectLocalService;
...
/**
 * Provides the base implementation for the qb project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.genpact.service.impl.QbProjectLocalServiceImpl}.
 * </p>
 *
 * @author 710008328
 * @see com.genpact.service.impl.QbProjectLocalServiceImpl
 * @see com.genpact.service.QbProjectLocalServiceUtil
 * @generated
 */
public abstract class QbProjectLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements QbProjectLocalService, IdentifiableBean {
    ...
    private QbProjectLocalServiceClpInvoker _clpInvoker = new QbProjectLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.genpact.service.QbProjectLocalServiceUtil} to access the qb project local service.
     */
    ...
    @Override
    public QbProject addQbProject(QbProject qbProject)
        throws SystemException {
        qbProject.setNew(true);

        return qbProjectPersistence.update(qbProject);
    }
     ...
     */
    @Override
    public QbProject createQbProject(long project_id) {
        return qbProjectPersistence.create(project_id);
    }
    ...
    @Override
    public QbProject deleteQbProject(long project_id)
        throws PortalException, SystemException {
        return qbProjectPersistence.remove(project_id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public QbProject deleteQbProject(QbProject qbProject)
        throws SystemException {
        return qbProjectPersistence.remove(qbProject);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(QbProject.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return qbProjectPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return qbProjectPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return qbProjectPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public QbProject fetchQbProject(long project_id) throws SystemException {
        return qbProjectPersistence.fetchByPrimaryKey(project_id);
    }
     ...
     */
    @Override
    public QbProject getQbProject(long project_id)
        throws PortalException, SystemException {
        return qbProjectPersistence.findByPrimaryKey(project_id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return qbProjectPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<QbProject> getQbProjects(int start, int end)
        throws SystemException {
        return qbProjectPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getQbProjectsCount() throws SystemException {
        return qbProjectPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public QbProject updateQbProject(QbProject qbProject)
        throws SystemException {
        return qbProjectPersistence.update(qbProject);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.genpact.model.QbProject",
            qbProjectLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.genpact.model.QbProject");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = qbProjectPersistence.getDataSource();
