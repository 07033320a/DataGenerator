...
/**
 * Provides the local service interface for DataGenerator. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author 710008328
 * @see DataGeneratorLocalServiceUtil
...
public interface DataGeneratorLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DataGeneratorLocalServiceUtil} to access the data generator local service. Add custom service methods to {@link com.genpact.service.impl.DataGeneratorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
