 ...
 * @generated
 */
public class TalendProcessLocalServiceClp implements TalendProcessLocalService {
    ...
    public TalendProcessLocalServiceClp(
    ...
    public com.genpact.model.TalendProcess addTalendProcess(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(talendProcess) });
        } catch (Throwable t) {
        ...
        return (com.genpact.model.TalendProcess) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.genpact.model.TalendProcess createTalendProcess(long processId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { processId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.genpact.model.TalendProcess deleteTalendProcess(long processId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { processId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.genpact.model.TalendProcess fetchTalendProcess(long processId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { processId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.genpact.model.TalendProcess> getTalendProcesses(
        ...
        return (java.util.List<com.genpact.model.TalendProcess>) ClpSerializer.translateOutput(returnObj);
    }
